...
<head>
    ...
    <style>
        ...
        .nav-pills .nav-link { color: var(--text-muted); transition: all 0.3s; }
        .nav-pills .nav-link.active { background: var(--primary-grad); color: white; box-shadow: 0 4px 10px rgba(0, 176, 155, 0.3); }
        ...
        .user-photo-card { width: 90px; height: 120px; object-fit: cover; border-radius: 10px; border: 2px solid rgba(255,255,255,0.5); background-color: white; box-shadow: 0 4px 10px var(--shadow-color); }
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div id="login-screen" style="transform: translateY(100%);">
            ...
            <div class="login-container">
                ...
                <ul class="nav nav-pills nav-fill mb-3 p-1 rounded-pill shadow-sm mx-auto" style="background-color: var(--card-bg); border: 1px solid var(--border-color); max-width: 260px;" id="login-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active rounded-pill fw-bold py-1 px-2" style="font-size: 13px;" id="tab-student" data-bs-toggle="pill" data-bs-target="#content-student" type="button" role="tab"><i class="fa-solid fa-graduation-cap me-1"></i> นักศึกษา</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill fw-bold py-1 px-2" style="font-size: 13px;" id="tab-staff" data-bs-toggle="pill" data-bs-target="#content-staff" type="button" role="tab"><i class="fa-solid fa-user-tie me-1"></i> เจ้าหน้าที่</button>
                    </li>
                </ul>

                <div class="tab-content" id="login-tab-content">
                    <div class="tab-pane fade show active" id="content-student" role="tabpanel">
                        <form onsubmit="handleManualLogin(event, 'student')">
                            <div class="card border-0 shadow-sm p-4 rounded-4 mb-3" style="background-color: var(--card-bg);">
                                ...
                                <div class="mb-3"><label class="form-label small text-muted" data-i18n="label_id">รหัสนักศึกษา</label><input type="number" id="manualLoginId" class="form-control form-control-lg border-0" placeholder="6XXXXXX" required style="border-radius: 15px; background-color: var(--input-bg); color: var(--text-main);"></div>
                                <div class="mb-1"><label class="form-label small text-muted" data-i18n="label_pass">รหัสผ่าน</label><input type="password" id="manualLoginPass" class="form-control form-control-lg border-primary" placeholder="Password" required style="border-radius: 15px; background-color: var(--input-bg); color: var(--text-main);"></div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn w-50 py-3 rounded-4 text-white fw-bold shadow-sm" style="background: var(--primary-grad); border: none; font-size: 16px;" data-i18n="btn_login">เข้าสู่ระบบ</button>
                                    <button type="button" class="btn btn-outline-success w-50 py-3 rounded-4 fw-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#registerModal" style="font-size: 16px; border-width: 2px;">
                                        <i class="fa-solid fa-user-plus me-1"></i><span data-i18n="btn_register">ลงทะเบียน</span>
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="tab-pane fade" id="content-staff" role="tabpanel">
                        <form onsubmit="handleManualLogin(event, 'staff')">
                            <div class="card border-0 shadow-sm p-4 rounded-4 mb-3" style="background-color: var(--card-bg);">
                                <h6 class="fw-bold mb-3 text-center" style="color: #2a5298;"><i class="fa-solid fa-shield-halved me-2"></i>เข้าสู่ระบบสำหรับเจ้าหน้าที่</h6>
                                <div class="mb-3">
                                    <label class="form-label small text-muted">ชื่อผู้ใช้งาน (Username / Admin ID)</label>
                                    <input type="text" id="staffLoginId" class="form-control form-control-lg border-0" placeholder="Username" required style="border-radius: 15px; background-color: var(--input-bg); color: var(--text-main);">
                                </div>
                                <div class="mb-1">
                                    <label class="form-label small text-muted">รหัสผ่าน (Password)</label>
                                    <input type="password" id="staffLoginPass" class="form-control form-control-lg border-0" placeholder="Password" required style="border-radius: 15px; background-color: var(--input-bg); color: var(--text-main); border: 1px solid #2a5298 !important;">
                                </div>
                                <div class="d-flex justify-content-end mb-4"><a href="https://lin.ee/28QmmAd" target="_blank" class="text-secondary small text-decoration-none" style="font-size: 0.85rem;"><i class="fa-solid fa-circle-question me-1"></i><span>ลืมรหัสผ่าน?</span></a></div>
                                <button type="submit" class="btn w-100 py-3 rounded-4 text-white fw-bold shadow-sm" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); border: none; font-size: 18px;">ลงชื่อเข้าใช้</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="container">
                <div id="page-home" class="page-section active">
                    ...
                    <div class="d-flex flex-column gap-3 mb-5">
                        <div class="glass-card p-3 d-flex align-items-center" onclick="openServiceWeb('สพฉ.', 'https://www.niems.go.th/1/SubWebsite/?id=38')">
                            <div class="icon-box bg-info bg-opacity-10 text-info me-3 mb-0"><i class="fa-solid fa-globe"></i></div>
                            <div>
                                <h6 class="fw-bold mb-1 text-main">เว็บไซต์ สพฉ.</h6>
                                <small class="text-muted">สถาบันการแพทย์ฉุกเฉินแห่งชาติ</small>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-md-4 col-lg-3" onclick="alert('Coming Soon')">
                                <div class="glass-card p-3 text-center">
                                    <div class="icon-box mx-auto" style="background-color: #e8eaf6; color: #3f51b5;">
                                        <i class="fa-solid fa-sitemap"></i>
                                    </div>
                                    <div class="fw-bold small">สายรหัส</div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-3" onclick="alert('Coming Soon')">
                                <div class="glass-card p-3 text-center">
                                    <div class="icon-box mx-auto" style="background-color: #e8f5e9; color: #2e7d32;">
                                        <i class="fa-solid fa-hand-holding-dollar"></i>
                                    </div>
                                    <div class="fw-bold small">ชำระเงินห้อง</div>
                                </div>
                            </div>
                            
                            <div class="col-6 col-md-4 col-lg-3" onclick="openWithdrawModal()">
                                <div class="glass-card p-3 text-center">
                            ...
                            <div class="col-6 col-md-4 col-lg-3" data-bs-toggle="modal" data-bs-target="#error404Modal">
                                <div class="glass-card p-3 text-center">
                            ...
                            <div class="col-6 col-md-4 col-lg-3" onclick="openFeedbackModal()">
                                <div class="glass-card p-3 text-center">
                                    <div class="icon-box mx-auto" style="background-color: #e3f2fd; color: #1976d2;">
                                        <i class="fa-solid fa-lightbulb"></i>
                                    </div>
                                    <div class="fw-bold small">แนะนำออกแบบแอปฯ</div>
                                </div>
                            </div>

                            <div class="col-6 col-md-4 col-lg-3" onclick="openEnrollmentModal()">
                                <div class="glass-card p-3 text-center position-relative">
                                    <div class="position-absolute top-0 end-0 bg-danger text-white px-2 py-1 shadow-sm" style="font-size: 0.55rem; border-bottom-left-radius: 10px; font-weight: bold;">นศ.ใหม่</div>
                                    <div class="icon-box mx-auto mt-2" style="background-color: #fce4ec; color: #c2185b;">
                                        <i class="fa-solid fa-address-card"></i>
                                    </div>
                                    <div class="fw-bold small">ขึ้นทะเบียน นศ.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-4 col-lg-3" id="adminCheckPaymentBtn" style="display: none;">
                                <div class="glass-card p-3 text-center" onclick="alert('ฟังก์ชันตรวจสอบการชำระสำหรับแอดมิน')">
                                    <div class="icon-box mx-auto bg-warning bg-opacity-10 text-warning">
                                        <i class="fa-solid fa-money-check-dollar"></i>
                                    </div>
                                    <div class="fw-bold small">ตรวจสอบการชำระ</div>
                                </div>
                            </div>
                ...
                <div id="page-faculty" class="page-section">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6 col-lg-4"><div class="glass-card p-3"><div class="d-flex align-items-start"><div class="me-3"><div class="rounded-circle bg-primary bg-opacity-10 text-primary d-flex justify-content-center align-items-center" style="width: 50px; height: 50px;"><i class="fa-solid fa-user-tie"></i></div></div><div><h6 class="fw-bold text-main mb-1">อ.นฉพ.ธนพรรณ วิริยะกุล</h6><div class="faculty-list-item">วท.บ.ฉุกเฉินการแพทย์</div></div></div></div></div>
                        <div class="col-12 col-md-6 col-lg-4"><div class="glass-card p-3"><div class="d-flex align-items-start"><div class="me-3"><div class="rounded-circle bg-primary bg-opacity-10 text-primary d-flex justify-content-center align-items-center" style="width: 50px; height: 50px;"><i class="fa-solid fa-user-tie"></i></div></div><div><h6 class="fw-bold text-main mb-1">อ.นฉพ.ณิชชาวีณ์ จิรหิรัณย์ภัทร</h6><div class="faculty-list-item">วท.บ.ฉุกเฉินการแพทย์</div></div></div></div></div>
                    </div>
                </div>
                            ...
                            <div id="account-main-view">
                                <div class="mb-4 position-relative overflow-hidden p-4 text-white shadow" style="background: var(--primary-grad); border-radius: 20px;">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <small class="text-uppercase letter-spacing-2 opacity-75">Paramedic Student</small>
                                            <h4 class="fw-bold mt-1 mb-0" id="card-name">ชื่อ นามสกุล</h4>
                                            <p class="m-0 opacity-75 mb-1" id="card-id">6XXXXXX</p>
                                            <small class="d-block" style="font-size: 0.75rem; opacity: 0.9; line-height: 1.4;">นักศึกษาฉุกเฉินการแพทยบัณฑิต<br>สถาบันพระบรมราชชนก</small>
                                            <span class="badge bg-white text-dark mt-1" id="card-sec" style="display:none;">-</span>
                                        </div>
                                        <div class="position-relative"><img id="card-user-img" src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" class="user-photo-card bg-white"><button onclick="document.getElementById('photoUploadInput').click()" class="btn btn-sm btn-light rounded-circle position-absolute" style="bottom: -5px; right: -5px; width: 32px; height: 32px; padding: 0; box-shadow: 0 2px 8px rgba(0,0,0,0.3);"><i class="fa-solid fa-camera" style="font-size: 13px;"></i></button><input type="file" id="photoUploadInput" accept="image/*" style="display: none;" onchange="handlePhotoUpload(event)"></div>
                                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-header border-0 pb-0">
                        <h5 class="modal-title fw-bold text-main"><i class="fa-solid fa-address-card me-2 text-danger"></i>ขึ้นทะเบียนนักศึกษาใหม่</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body py-4">
                        <form id="enrollmentForm" onsubmit="handleEnrollmentSubmit(event)">
                            <div class="mb-3">
                                <label class="small text-muted mb-1">1. คำนำหน้า และ 2. ชื่อ-สกุล</label>
                                <div class="input-group shadow-sm">
                                    <select class="form-select border-0" id="enrollPrefix" required style="max-width: 120px; background-color: var(--input-bg); color: var(--text-main);">
                                        <option value="" disabled selected>คำนำหน้า</option>
                                        <option value="นาย">นาย</option>
                                        <option value="นางสาว">นางสาว</option>
                                        <option value="นาง">นาง</option>
                                    </select>
                                    <input type="text" id="enrollName" class="form-control border-0" placeholder="ชื่อ-สกุล" required style="background-color: var(--input-bg); color: var(--text-main);">
                                </div>
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">3. อายุ (ปี)</label>
                                <input type="number" id="enrollAge" class="form-control border-0 shadow-sm" placeholder="ระบุอายุ" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">4. วัน/เดือน/ปีเกิด</label>
                                <input type="date" id="enrollDob" class="form-control border-0 shadow-sm" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">5. รหัสประจำตัวนักศึกษา</label>
                                <input type="number" id="enrollStudentId" class="form-control border-0 shadow-sm" placeholder="6XXXXXX" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">6. ที่อยู่</label>
                                <textarea id="enrollAddress" class="form-control border-0 shadow-sm" rows="2" placeholder="ระบุที่อยู่ปัจจุบัน" required style="background-color: var(--input-bg); color: var(--text-main);"></textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">7. โรคประจำตัว (ถ้าไม่มีระบุ -)</label>
                                <input type="text" id="enrollDisease" class="form-control border-0 shadow-sm" placeholder="ระบุโรคประจำตัว" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">8. หมู่เลือด</label>
                                <select id="enrollBloodGroup" class="form-select border-0 shadow-sm mb-2" onchange="toggleEnrollBloodGroup()" required style="background-color: var(--input-bg); color: var(--text-main);">
                                ...
                                <input type="text" id="enrollBloodGroupOther" class="form-control border-0 shadow-sm" placeholder="โปรดระบุหมู่เลือด..." style="display: none; background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-3">
                                <label class="small text-muted mb-1">9. โทรศัพท์ติดต่อ</label>
                                <input type="tel" id="enrollPhone" class="form-control border-0 shadow-sm" placeholder="เบอร์โทรศัพท์มือถือ" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            
                            <div class="mb-4">
                                <label class="small text-muted mb-1">10. โทรศัพท์ฉุกเฉิน 1 และ 2</label>
                                <input type="tel" id="enrollEmer1" class="form-control border-0 shadow-sm mb-2" placeholder="โทรศัพท์ฉุกเฉิน 1" required style="background-color: var(--input-bg); color: var(--text-main);">
                                <input type="tel" id="enrollEmer2" class="form-control border-0 shadow-sm" placeholder="โทรศัพท์ฉุกเฉิน 2 (ถ้ามี)" style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>

                            <button type="submit" class="btn w-100 py-3 rounded-4 text-white fw-bold shadow-sm" style="background: var(--primary-grad); border: none; font-size: 16px;">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-body text-center py-5">
                        ...
                        <p class="text-muted mb-4 small">รหัส หรือรหัสผ่านไม่ถูกต้อง<br>โปรดลองใหม่อีกครั้ง</p>
        ...
        <div class="modal fade" id="duplicateAccountModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-body text-center py-5">
                        <div class="mb-3">
                            <i class="fa-solid fa-user-xmark text-warning" style="font-size: 65px; animation: pulse 1s infinite;"></i>
                        </div>
                        <h4 class="fw-bold text-warning mb-2">ลงทะเบียนไม่สำเร็จ</h4>
                        <p class="text-muted mb-4 small">ขออภัยท่านมีบัญชีอยู่แล้ว<br>โปรดลองใหม่อีกครั้ง หรือเข้าสู่ระบบ</p>
                        <button type="button" class="btn btn-warning text-white w-75 rounded-pill shadow-sm fw-bold" data-bs-dismiss="modal">
                            ตกลง (OK)
                        </button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="error404Modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-body text-center py-5">
                        <div class="mb-3">
                            <i class="fa-solid fa-triangle-exclamation text-warning" style="font-size: 65px; animation: pulse 1s infinite;"></i>
                        </div>
                        <h2 class="fw-bold text-dark mb-2">Er 404</h2>
                        <p class="text-muted mb-4 small">ไม่พบหน้าเว็บ หรือระบบกำลังปรับปรุง</p>
                        <button type="button" class="btn btn-warning text-white w-75 rounded-pill shadow-sm fw-bold" data-bs-dismiss="modal">
                            ปิดหน้าต่าง
                        </button>
                    </div>
        ...
        <div class="modal fade" id="withdrawModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-header border-0 pb-0">
                        <h5 class="modal-title fw-bold text-main"><i class="fa-solid fa-file-invoice-dollar me-2 text-warning"></i>เบิกเงินห้อง</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="withdrawForm" onsubmit="handleWithdrawSubmit(event)">
                            <div class="mb-3">
                                <label class="small text-muted mb-1">1. ชื่อ-สกุลผู้เบิก</label>
                                <div class="input-group shadow-sm">
                                    <span class="input-group-text bg-light text-muted border-0"><i class="fa-solid fa-user"></i></span>
                                    <input type="text" id="withdrawName" class="form-control border-0" readonly style="background-color: #e9ecef; color: #495057; font-weight: bold;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="small text-muted mb-1">2. จำนวนเงินที่ต้องการเบิก (บาท)</label>
                                <div class="input-group shadow-sm">
                                    <span class="input-group-text bg-light text-muted border-0"><i class="fa-solid fa-baht-sign"></i></span>
                                    <input type="number" id="withdrawAmount" class="form-control border-0" placeholder="ระบุจำนวนเงิน..." required min="1" style="background-color: var(--input-bg); color: var(--text-main);">
                                </div>
                            </div>
                            <div class="mb-4">
                                <label class="small text-muted mb-1">3. แนบรูปเพื่อตรวจสอบ (ใบเสร็จ/หลักฐาน)</label>
                                <input type="file" id="withdrawImage" class="form-control border-0 shadow-sm" accept="image/*" required style="background-color: var(--input-bg); color: var(--text-main);">
                            </div>
                            <button type="submit" class="btn w-100 py-3 rounded-4 text-white fw-bold shadow-sm" style="background: var(--primary-grad); border: none; font-size: 16px;">ยืนยันการเบิกเงิน</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="feedbackModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0">
                    <div class="modal-header border-0 pb-0">
                        <h5 class="modal-title fw-bold text-main"><i class="fa-solid fa-lightbulb me-2 text-primary"></i>แนะนำการออกแบบแอปฯ</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="feedbackForm" onsubmit="handleFeedbackSubmit(event)">
                            <div class="mb-3">
                                <label class="small text-muted mb-1 fw-bold">ข้อเสนอแนะ/แนะนำการออกแบบ</label>
                                <textarea id="feedbackText" class="form-control border-0 shadow-sm" rows="4" placeholder="พิมพ์ข้อเสนอแนะของคุณที่นี่..." required style="background-color: var(--input-bg); color: var(--text-main);"></textarea>
                            </div>
                            <button type="submit" class="btn w-100 py-3 rounded-4 text-white fw-bold shadow-sm" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border: none; font-size: 16px;">
                                <i class="fa-solid fa-paper-plane me-2"></i> ส่งคำแนะนำ
                            </button>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        async function handleManualLogin(e, role) {
            e.preventDefault();
            
            let id, pass;
            if (role === 'student') {
                id = document.getElementById('manualLoginId').value;
                pass = document.getElementById('manualLoginPass').value;
            } else {
                id = document.getElementById('staffLoginId').value;
                pass = document.getElementById('staffLoginPass').value;
            }
            
            document.getElementById('loading-overlay').style.display = 'flex';
            
            try {
                const response = await fetch(LOGIN_SCRIPT_URL + "?action=login&id=" + encodeURIComponent(id) + "&password=" + encodeURIComponent(pass) + "&role=" + role);
                const data = await response.json();
                ...
                if(data.success) {
                    ...
                    if (role === 'student') incrementLoginAttempt();
                ...
                console.error(err);
                document.getElementById('loading-overlay').style.display = 'none';
                alert("Server Error: ขัดข้องในการเชื่อมต่อ");
            }
        }
        ...
        function updateUI() {
            ...
            document.getElementById('card-name').innerText = (userProfile.role === 'staff' ? "" : "นศ.ฉพ. ") + userProfile.name;
            ...
            // ตรวจสอบสถานะ Admin เพื่อแสดงปุ่มสำหรับแอดมินเท่านั้น
            const admins = ["แอดมิน", "แอดมิน1", "แอดมิน2", "แอดมิน3"];
            if (userProfile.role === 'staff' || admins.some(adminName => userProfile.name.includes(adminName))) {
                document.getElementById('adminCheckEquipBtn').style.display = 'block';
                document.getElementById('adminCheckPaymentBtn').style.display = 'block';
            } else {
                document.getElementById('adminCheckEquipBtn').style.display = 'none';
                document.getElementById('adminCheckPaymentBtn').style.display = 'none';
            }
        }
        ...
        async function handleRegisterSubmit(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.message && (data.message.includes("ลงทะเบียนไปแล้ว") || data.message.includes("มีบัญชีอยู่แล้ว"))) {
                        const regModalInstance = bootstrap.Modal.getInstance(document.getElementById('registerModal'));
                        if(regModalInstance) regModalInstance.hide();
                        
                        const dupModal = new bootstrap.Modal(document.getElementById('duplicateAccountModal'));
                        dupModal.show();
                    } else {
        ...
        function toggleEnrollBloodGroup() {
            const select = document.getElementById('enrollBloodGroup');
            const otherInput = document.getElementById('enrollBloodGroupOther');
        ...
        async function handleEnrollmentSubmit(e) {
            ...
            setTimeout(() => {
                alert("✅ ขึ้นทะเบียนนักศึกษาใหม่เรียบร้อยแล้ว");
                const modal = bootstrap.Modal.getInstance(document.getElementById('enrollmentModal'));
                if (modal) modal.hide();
                e.target.reset();
                document.getElementById('enrollBloodGroupOther').style.display = 'none';
                btn.innerHTML = originalText;
                btn.disabled = false;
            }, 1000);
        }
        ...
        function openWithdrawModal() {
            ...
            document.getElementById('withdrawName').value = "นศ.ฉพ. " + userProfile.name;
        ...
        async function handleWithdrawSubmit(e) {
            ...
            const fileInput = document.getElementById('withdrawImage');
                ...
                reader.onload = async function(event) {
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            modal.hide();
                            alert("✅ ส่งข้อมูลการเบิกเงินห้องเรียบร้อยแล้ว (รอการตรวจสอบ)");
                        } else {
                            alert("✅ ส่งคำขอเบิกเงินเรียบร้อยแล้ว \n(หมายเหตุ: ระบบอาจอยู่ระหว่างอัปเดต Backend)");
                            const modal = bootstrap.Modal.getInstance(document.getElementById('withdrawModal'));
                            modal.hide();
                        }
                    } catch (error) {
                        console.error("Error:", error);
                        alert("✅ ยื่นเรื่องเบิกสำเร็จ (จำลองการทำงาน - เนื่องจาก API ยังไม่รองรับ)"); 
                        const modal = bootstrap.Modal.getInstance(document.getElementById('withdrawModal'));
                        if(modal) modal.hide();
                    } finally {
                        btn.innerHTML = originalText;
        ...
        async function handleFeedbackSubmit(e) {
            ...
            const btn = e.target.querySelector('button[type="submit"]');
            const originalText = btn.innerHTML;
            btn.innerHTML = '<i class="fa-solid fa-spinner fa-spin me-2"></i>กำลังส่ง...';
            btn.disabled = true;

            const formData = {
                action: 'appFeedback',
                name: "นศ.ฉพ. " + userProfile.name,
                feedback: text,
                timestamp: new Date().toLocaleString('th-TH')
            };
            ...
            try {
                ...
                alert("✅ ขอบคุณสำหรับคำแนะนำครับ ระบบได้บันทึกข้อเสนอแนะของคุณแล้ว");
